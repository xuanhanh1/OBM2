...
function PhatHanhHoSo(props) {
  ...
  useEffect(() => {
    ...
    let status1 = `and status_id eq dbf2da25-f93a-4989-a00c-51c179f2f966`;
  ...
  const handleUpdate = () => {
    ...
    callApi(`odata/BiddingDocuments/UpdateStatus?key=${isObjEdit.id}`, "PUT")
      .then((res) => {
        openNotificationWithIcon("success", "Mở thầu thành công");
        handleSearch();
...
PhatHanhHoSo.propTypes = {
  columns: PropTypes.array,
  PhatHanhHoSo: PropTypes.object,
};
PhatHanhHoSo.defaultProps = {
  columns: [
    {
      caption: "Mã gói thầu",
      dataField: "code",
