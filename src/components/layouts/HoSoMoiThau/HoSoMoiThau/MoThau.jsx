...
function MoThau(props) {
  ...
  useEffect(() => {
    ...
    let status1 = `and status_id eq 9d60692b-d5b3-48a5-9239-b961ad2d7161`;
    ...
    callApi(`odata/BiddingDocuments/UpdateStatus?key=${isObjEdit.id}`, "PUT")
      .then((res) => {
        openNotificationWithIcon(
          "success",
          "Hồ sơ chuyển trạng thái chấm thầu thành công"
        );
        handleSearch();
