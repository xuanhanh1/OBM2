...
import "../../NopHoSoThau/ModalCreateAndEdit/index.css";
...
function ModalUploadExcel(props) {
  const {
    objEdit,
    columns,
    columnsChoice,
  ...
  const handleUploadFile = () => {
    setIsLoading(true);
    callApi(
      `odata/BidDetails/ImportExcelPrice?bid_id=${lstBid[0].id}`,
      "POST",
      isFileExcel,
      "multipart/form-data"
    )
...
ModalUploadExcel.propTypes = {
  columns: PropTypes.array,
  columnsChoice: PropTypes.array,
  ModalUploadExcel: PropTypes.object,
};
ModalUploadExcel.defaultProps = {
  columns: [
    {
